...
export default class Modal extends ReactComponent {
    ...
    render() {
        return (
            <div>
                <div className={cx(styles.modal, styles['modal-' + this.props.size], (this.state.visible)?styles.visible:styles.invisible, this.props.classNames)}>
                ...
                <div className={cx(styles['modal-shadow-bg'], (this.state.visible)?styles.visible:styles.invisible)}></div>
            </div>
        );
    }
}