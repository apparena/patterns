...
import {
  ReactComponent, Dropdown, ButtonGroup, Icon, Input, Button, Checkbox, RadioButton,
} from '../../index';
          ...
          case 1:
            ...
            container.push(
              <li className={classNameString}>
                ...
                >
                  <Icon name="sort-amount-desc" key={key} />
absteigend
    ...
    return (
      <div>
        <div className="filter-bar p-1">
          {(this.props.filter.groups.length >= 1)
                    ...
                    <div className="filter-bar-filter mr-1">
                      <a
                        className={this.props.filter.buttonClass ? this.props.filter.buttonClass : 'btn btn-primary collapsed'}
        ...
        {this.props.filter
                && (
                <div
                  className={cx('collapse', this.props.filter.status.expanded ? 'in' : '')}
                  id="collapseFilter"
...
FilterBar.PropTypes = {
  filter: PropTypes.shape({
    ...
    groups: PropTypes.arrayOf(PropTypes.shape({
      type: PropTypes.oneOf(['radiobutton', 'checkbox']).isRequired,
